...
function Payment() {
  ...
  return (
    <div className="pt-32">
      <div>
        <form className="shadow-2xl rounded shadow-gray-800 w-96 p-5 m-auto space-y-5 flex flex-col items-center"
        ...
        >
          ...
          <input
            ...
            required
          />
          <p className="text-2xl font-semibold">Total Price : Rs {total_amount}</p>
          <input className="bg-green-500 text-white p-2 w-20 rounded-2xl" value="Submit" type="submit" />
           <NavLink to='/menu'><button className="bg-red-600 p-2 w-20 text-white rounded-2xl ">Cancel</button></NavLink>
        </form>
      </div>
    </div>
  );
